...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.noti_text.move(10, 430)

        self.start_button.move(10, 400)
        self.stop_button.move(120, 400)
        self.choose_image.move(10, 400)
        self.image_path = ""
    ...
    def getFile(self):
        try:
            ...
            if fname[0] != "":
                ...
                self.choose_image.setVisible(False)
